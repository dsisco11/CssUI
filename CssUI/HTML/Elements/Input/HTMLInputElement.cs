    ...
    {/* Docs: https://html.spec.whatwg.org/multipage/input.html#the-input-element */
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#dom-input-valueasdate */
            ...
            set
            {
                switch (type)
                {
                    ...
                    default:
                        {
                            if (THROW_FOR_METHOD_INVALID_TYPES) throw new InvalidStateError(string.Format(CultureInfo.InvariantCulture, ExceptionMessages.ERROR_InputElement_Value_Cannot_Convert, Enum.GetName(typeof(EInputType), type)));
                            else return;
                        }
                }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#dom-input-valueasnumber */
            ...
            set
            {
                ...
                if (double.IsInfinity(value)) throw new TypeError(ExceptionMessages.ERROR_Invalid_Value_Infinity);
            ...
            set
            {
                CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
                {
                    switch (type)
                    {
                        ...
                        default:
                            {
                                if (THROW_FOR_ATTR_INVALID_TYPES) throw new InvalidStateError(string.Format(CultureInfo.InvariantCulture, ExceptionMessages.ERROR_InputElement_Invalid_Attribute, Enum.GetName(typeof(EInputType), type)));
                                else return;
                            }
                    }

                    setAttribute(EAttributeName.Accept, AttributeValue.From(value));
                });
            }
        }
        ...
        public string alt
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Alt, AttributeValue.From(value));
            });
        }
        ...
        public string autocomplete
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Autocomplete, AttributeValue.From(value));
            });
        }
        ...
        public string dirName
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Dirname, AttributeValue.From(value));
            });
        }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#dom-fs-formaction */
            get
            {
                var attrValue = getAttribute(EAttributeName.FormAction)?.AsString();
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.FormAction, AttributeValue.From(value));
            });
        }
        ...
        public string formTarget
        {
            ...
            set
            {
                CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
                {
                    ...
                    {
                        throw new DOMException(string.Format(CultureInfo.InvariantCulture, ExceptionMessages.ERROR_FormTarget_Invalid_Value, value));
                    }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#dom-input-height */
            ...
            set
            {
                CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
                {
                    ...
                    setAttribute(EAttributeName.Height, AttributeValue.From(value));
                });
            }
        }
        ...
        public string max
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Max, AttributeValue.From(value));
            });
        }
        ...
        public int maxLength
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.MaxLength, AttributeValue.From(value));
            });
        }
        ...
        public string min
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Min, AttributeValue.From(value));
            });
        }
        ...
        public int minLength
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.MinLength, AttributeValue.From(value));
            });
        }
        ...
        public string placeholder
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Placeholder, AttributeValue.From(value));
            });
        }
        ...
        public uint size
        {
            get => getAttribute(EAttributeName.Size).AsUInt();
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                switch (type)
                {
                ...
                setAttribute(EAttributeName.Size, AttributeValue.From(value));
            });
        }
        ...
        public string src
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Src, AttributeValue.From(value));
            });
        }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#dom-input-width */
            ...
            set
            {
                CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
                {
                    ...
                    setAttribute(EAttributeName.Width, AttributeValue.From(value));
                });
            }
        }
        ...
        public string step
        {
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
            {
                ...
                setAttribute(EAttributeName.Step, AttributeValue.From(value));
            });
        }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#concept-input-min-zero */
            get
            {
                ...
                if (hasAttribute(EAttributeName.Min, out Attr outMinAttr) && outMinAttr.Value != null && convert_string_to_number(outMinAttr.Value.AsString().AsMemory(), out double outMin))
                {
                    return outMin;
                }
                ...
                if (hasAttribute(EAttributeName.Value, out Attr outValueAttr) && outValueAttr.Value != null && convert_string_to_number(outValueAttr.Value.AsString().AsMemory(), out double outValue))
                {
                    return outValue;
                }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#concept-input-step */
            get
            {
                ...
                if (!hasAttribute(EAttributeName.Step, out Attr outAttr) || outAttr?.Value?.AsString() is null)
                    return default_step * step_scale_factor;

                string value = outAttr.Value.AsString();
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#dom-input-stepup */
            switch (type)
            {
                ...
                default:
                    {
                        if (THROW_FOR_METHOD_INVALID_TYPES) throw new InvalidStateError(string.Format(CultureInfo.InvariantCulture, ExceptionMessages.ERROR_InputElement_Method_Unsupported_By_InputType, Enum.GetName(typeof(EInputType), type)));
                        else return;
                    }
            }
            ...
            {
                throw new InvalidStateError(ExceptionMessages.ERROR_InputElement_Missing_Allowed_Value_Step);
            }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/input.html#dom-input-value */
            get
            {
                ...
                {
                    if (nameAttr.Value.AsString().Equals("_charset_", StringComparison.OrdinalIgnoreCase))
                    {
                        return string.Empty;
                    }
                }
                ...
                switch (Get_Input_Value_Mode(type))
                {
                    ...
                    case EInputValueMode.Default:
                        {
                            return getAttribute(EAttributeName.Value)?.AsString() ?? string.Empty;
                        }
                    case EInputValueMode.Default_ON:
                        {
                            return getAttribute(EAttributeName.Value)?.AsString() ?? "on";
                        }
                    ...
                    switch (Get_Input_Value_Mode(type))
                    {
                        case EInputValueMode.Value:
                            {
                                ...
                                run_value_sanitization();
                                if (!StringCommon.StrEq(_value, oldValue))
                                {
                        ...
                        case EInputValueMode.Filename:
                            {/* On setting, if the new value is the empty string, empty the list of selected files; otherwise, throw an "InvalidStateError" DOMException. */
                                ...
                                {
                                    throw new InvalidStateError(ExceptionMessages.ERROR_InputElement_InputType_Value_Must_Be_Empty);
                                }
                            }
                            break;
                    }
                ...
                case EInputType.Date:
                    {
                        ...
                        outValue = date.ToString(HTMLParserCommon.DATE_TIME_FORMAT, CultureInfo.InvariantCulture);
                ...
                case EInputType.Month:
                    {
                        ...
                        outValue = date.ToString(HTMLParserCommon.MONTH_FORMAT, CultureInfo.InvariantCulture);
                ...
                case EInputType.Week:
                    {
                        ...
                        outValue = date.ToString($"yyyy-W{week}", CultureInfo.InvariantCulture);
                ...
                case EInputType.Time:
                    {
                        ...
                        outValue = time.ToString(HTMLParserCommon.TIME_FORMAT, CultureInfo.InvariantCulture);
                ...
                case EInputType.Local:
                    {
                        ...
                        outValue = date.ToString(HTMLParserCommon.LOCAL_DATE_TIME_FORMAT, CultureInfo.InvariantCulture);
                        return true;
                    }
                case EInputType.Number:
                case EInputType.Range:
                    {
                        outValue = num.ToString(CultureInfo.InvariantCulture);
                        return true;
                    }
                default:
                    {
        ...
        bool convert_date_to_string(DateTimeOffset date, out string outValue)
        {
            switch (type)
            {
                ...
                case EInputType.Time:
                    {
                        outValue = date.ToString(HTMLParserCommon.TIME_FORMAT, CultureInfo.InvariantCulture);
                        return true;
                    }
                default:
                    {
            ...
            switch (type)
            {
                ...
                case EInputType.Search:
                    {/* The value sanitization algorithm is as follows: Strip newlines from the value. */
                        _value = StringCommon.Replace(_value.AsMemory(), FilterCRLF.Instance, string.Empty);
                    }
                    break;
                case EInputType.Telephone:
                    {/* The value sanitization algorithm is as follows: Strip newlines from the value. */
                ...
                case EInputType.Url:
                    {/* The value sanitization algorithm is as follows: Strip newlines from the value, then strip leading and trailing ASCII whitespace from the value. */
                        _value = StringCommon.Replace(_value.AsMemory(), FilterCRLF.Instance, string.Empty).Trim();
                    }
                    break;
                case EInputType.Email:
                    {
                ...
                case EInputType.Local:
                    {
                        if (!HTMLParserCommon.Parse_Local_Date_Time_String(_value.AsMemory(), out DateTime dateTime))
                            _value = dateTime.ToString(HTMLParserCommon.LOCAL_DATE_TIME_FORMAT, CultureInfo.InvariantCulture);
                        else
                            _value = string.Empty;
                    }
                    break;
                ...
                case EInputType.Range:
                    {
                        if (!HTMLParserCommon.Is_Valid_FloatingPoint(_value.AsMemory()))
                        {
                            ...
                            if (min < max)
                            {
                                _value = (min + (max - min) * 0.5).ToString(CultureInfo.InvariantCulture);
                            }
                            else
                            {
                                _value = min.ToString(CultureInfo.InvariantCulture);
                            }
                        }
                    }
                    break;
        ...
        internal override EValidityState query_validity()
        {
            ...
            string cValue = value;/* Cache this so we dont keep resolving it */
            ...
            switch (type)
            {
                ...
                default:
                    {
                        if (cValue is null || cValue.Length <= 0)
                        {
                            flags |= EValidityState.valueMissing;
                        }
                    }
                            ...
                            case EInputType.Range:
                                {
                                    ...
                                    if (MathExt.Fgteq(remainder, 0.5d))// step up is closest
                                    {
                                        ...
                                        if (upStep <= max)
                                        {
                                            cValue = upStep.ToString(CultureInfo.InvariantCulture);
                                            break;
                                        }
                                    }
                                    ...
                                    if (noStep >= min)
                                    {
                                        cValue = noStep.ToString(CultureInfo.InvariantCulture);
                                        break;
                                    }
                                }
                                break;
            ...
            if (cValue is object && cValue.Length > 0)/* Value is not null or empty string */
            {
                        ...
                        case EInputType.Range:
                            {
                                ...
                                {
                                    flags |= EValidityState.rangeUnderflow;
                                    cValue = min.Value.ToString(CultureInfo.InvariantCulture);
                                }
                                ...
                                {
                                    flags |= EValidityState.rangeOverflow;
                                    cValue = max.Value.ToString(CultureInfo.InvariantCulture);
                                }
                            }
                            break;
                    }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#dom-textarea/input-select */
            ...
            if (!StringCommon.Contains(value, FilterCharSelectable.Instance))
            {
                return;
            }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#dom-textarea/input-setselectionrange */
         /* 1) If this element is an input element, and selectionStart does not apply to this element, throw an "InvalidStateError" DOMException. */
            ...
            {
                dispatchEvent(new Event(EEventName.Select, new EventInit() { bubbles = true })).ConfigureAwait(false);
            }
        }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#dom-textarea/input-setrangetext */
         /* 1) If this element is an input element, and selectionStart does not apply to this element, throw an "InvalidStateError" DOMException. */
            ...
            if (start > end)
            {
                throw new IndexSizeError(ExceptionMessages.ERROR_InputElement_InvalidValue_Start_Greater_Than_End);
            }
        ...
        internal IReadOnlyCollection<HTMLInputElement> Get_Radio_Button_Group()
        {
            ...
            if (root == null) return Array.Empty<HTMLInputElement>();

            return DOMCommon.Get_Descendents<HTMLInputElement>(root, new FilterRadioGroup(this), ENodeFilterMask.SHOW_ELEMENT);
        }
        /// <summary>
        ...
        internal override void activation_behaviour(Event @event)
        {
            ...
            switch (type)
            {
                ...
                case EInputType.Radio:
                    {
                        dispatchEvent(new Event(EEventName.Input, new EventInit() { bubbles = true })).ConfigureAwait(continueOnCapturedContext: false);
                        dispatchEvent(new Event(EEventName.Change, new EventInit() { bubbles = true })).ConfigureAwait(continueOnCapturedContext: false);
                    }
                    break;
        ...
        internal override void legacy_canceled_pre_activation_behaviour()
        {
            ...
            {
                if (legacyPreActivation_RadioRef is object)
                {
                    var group = Get_Radio_Button_Group();
