...
namespace CssUI.HTML
{
    ...
    {/* Docs: https://html.spec.whatwg.org/multipage/embedded-content.html#htmlimageelement */
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/embedded-content.html#dom-img-width */
            get => getAttribute(EAttributeName.Width)?.AsUInt() ?? naturalWidth;
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () => setAttribute(EAttributeName.Width, AttributeValue.From(value)));
        }
        [CEReactions]
        public uint height
        {/* Docs: https://html.spec.whatwg.org/multipage/embedded-content.html#dom-img-height */
            get => getAttribute(EAttributeName.Height)?.AsUInt() ?? naturalHeight;
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () => setAttribute(EAttributeName.Height, AttributeValue.From(value)));
        }
