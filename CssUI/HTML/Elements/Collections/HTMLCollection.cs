...
namespace CssUI.HTML
{
    ...
    {/* Docs: https://html.spec.whatwg.org/multipage/common-dom-interfaces.html#htmloptionscollection */
        ...
        #region Accessors
        protected IReadOnlyList<ElementType> Collection => DOMCommon.Get_Descendents<ElementType>(root, CollectionFilter, ENodeFilterMask.SHOW_ELEMENT).ToArray();
        #endregion
        ...
        public virtual ElementType this[string name]
        {
            get
            {
                ...
                return DOMCommon.Get_Nth_Descendant<ElementType>(root, 1, new FilterNamedElement(name), ENodeFilterMask.SHOW_ELEMENT);
            }
        }
