...
namespace CssUI.HTML
{
    ...
    {/* Docs: https://html.spec.whatwg.org/multipage/dom.html#htmlelement */
        ...
        public EDir Dir
        {
            get => getAttribute(EAttributeName.Dir).AsEnum<EDir>();
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () => setAttribute(EAttributeName.Dir, AttributeValue.From(value)));
        }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/interaction.html#attr-tabindex */
            get
            {
                ...
                int attrValue = Attrib?.Value?.AsInt() ?? -1;
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () => setAttribute(EAttributeName.TabIndex, AttributeValue.From(value)));
        }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/interaction.html#assigned-access-key */
         /* Whenever an element's accesskey attribute is set, changed, or removed, the user agent must update the element's assigned access key by running the following steps: */
            ...
            if (hasAttribute(EAttributeName.AccessKey, out Attr outAttr) && outAttr.IsDefined)
            {
                ...
                var keys = StringCommon.Strtok(outAttr.Value.AsString().AsMemory(), UnicodeCommon.CHAR_SPACE);
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/dnd.html#the-draggable-attribute */
            get
            {
                ...
                EDraggable attrValue = attr.Value.AsEnum<EDraggable>();
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () => setAttribute(EAttributeName.Draggable, AttributeValue.From(value ? EDraggable.True : EDraggable.False)));
        }
        ...
        {/* Docs: https://html.spec.whatwg.org/multipage/interaction.html#spelling-and-grammar-checking */
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () => setAttribute(EAttributeName.Spellcheck, AttributeValue.From(value ? ESpellcheck.True : ESpellcheck.False)));
        }
        ...
        public EAutoCapitalizationHint Autocapitalize
        {
            get
            {
                ...
                if (attr != null)
                {
                    var enumValue = attr.Value.AsEnum<EAutoCapitalizationHint>();
            ...
            set => CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () => setAttribute(EAttributeName.Autocapitalize, AttributeValue.From(value)));
        }
        ...
        public EContentEditable ContentEditable
        {
            ...
            get => getAttribute(EAttributeName.ContentEditable).AsEnum<EContentEditable>();
            set
            {
                CEReactions.Wrap_CEReaction(nodeDocument.defaultView, () =>
                {
                    setAttribute(EAttributeName.ContentEditable, AttributeValue.From(value));
                });
            }
        }
        ...
        public bool isContentEditable
        {
            get
            {
                ...
                EContentEditable attrValue = attr.Value.AsEnum<EContentEditable>();
