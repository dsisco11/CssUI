...
namespace CssUI.HTML
{
    ...
    public enum EReferrerPolicy : int
    {
        ...
        /// </summary>
        [EnumRecordProperties("no-referrer")]
        No_Referrer,
        ...
        /// </summary>
        [EnumRecordProperties("no-referrer-when-downgrade")]
        ...
        /// </summary>
        [EnumRecordProperties("same-origin")]
        Same_Origin,
        ...
        /// </summary>
        [EnumRecordProperties("origin-when-cross-origin")]
        ...
        /// </summary>
        [EnumRecordProperties("strict-origin-when-cross-origin")]
        ...
        /// </summary>
        [EnumRecordProperties("unsafe-url")]
        Unsafe_Url,
    }
}
