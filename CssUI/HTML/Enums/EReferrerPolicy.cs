...
namespace CssUI.HTML
{
    ...
    public enum EReferrerPolicy : int
    {
        ...
        /// </summary>
        [EnumData("no-referrer-when-downgrade")]
        ...
        /// </summary>
        [EnumData("origin-when-cross-origin")]
        ...
        /// </summary>
        [EnumData("strict-origin-when-cross-origin")]
