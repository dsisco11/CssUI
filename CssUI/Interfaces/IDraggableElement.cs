...
namespace CssUI
{
    ...
    public interface IDraggableElement
    {
        ...
        /// </summary>
        void Handle_DraggingStart(uiElement Sender, ItemDragEventArgs Args);
        /// <summary>
        /// Fired as the element is being dragged
        /// </summary>
        void Handle_DraggingUpdate(uiElement Sender, ItemDragEventArgs Args);
        /// <summary>
        /// Fires when the dragging operation is confirmed (ended without cancelling)
        /// </summary>
        void Handle_DraggingConfirm(uiElement Sender, ItemDragEventArgs Args);
        /// <summary>
        /// Fires when the dragging operation ends (including being cancelled)
        /// Called AFTER <see cref="Handle_DraggingConfirm"/>
        /// </summary>
        void Handle_DraggingEnd(uiElement Sender, ItemDragEventArgs Args);
    }
}
