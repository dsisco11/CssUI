...
{/* Docs: https://www.w3.org/TR/DOM-Parsing/ */
    ...
    private static bool Is_Valid_Month_String(DataConsumer<char> Stream)
    ...
    private static bool Consume_Month_Component(DataConsumer<char> Stream, out int outYear, out int outMonth)
    ...
    private static bool Is_Valid_Date_String(DataConsumer<char> Stream)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-date-string */
    ...
    private static bool Consume_Date_Component(DataConsumer<char> Stream, out int outYear, out int outMonth, out int outDay)
    ...
    private static bool Is_Valid_Yearless_Date_String(DataConsumer<char> Stream)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-yearless-date-string */
    ...
    private static bool Consume_Yearless_Date_Component(DataConsumer<char> Stream, out int outMonth, out int outDay)
    ...
    private static bool Is_Valid_Time_String(DataConsumer<char> Stream)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-time-string */
    ...
    private static bool Is_Valid_Normalized_Time_String(DataConsumer<char> Stream)
    {/* Normalized just means we dont have a seconds component present if its 0 */
    ...
    private static bool Consume_Time_Component(DataConsumer<char> Stream, out int outHours, out int outMinutes, out double outSeconds)
    ...
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#parse-a-time-string */
        ...
        if (!Consume_Time_Component(Stream, out int hours, out int minutes, out var seconds))
        {
    ...
    private static bool Is_Valid_TimeZone_Offset_String(DataConsumer<char> Stream)
    ...
    private static bool Consume_TimeZone_Offset_Component(DataConsumer<char> Stream, out int outTimezoneHours, out int outTimezoneMinutes)
    ...
    public static bool Is_Valid_Week_String(DataConsumer<char> Stream)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-week-string */
    ...
    private static bool Is_Valid_Duration_String(DataConsumer<char> Stream, double TimeInSeconds)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-duration-string */
        ...
        if (Stream.Next == CHAR_P_UPPER)
        {
            ...
            if (Stream.Next == CHAR_T_UPPER)
            {
                ...
                Stream.Scan(ch => !Is_Ascii_Digit(ch), out nextNonDigit, 0);
        ...
        else
        {
            ...
            {
                Consume_Duration_Time_Component(Stream, out var outSeconds);
    ...
    private static bool Parse_Duration_String(DataConsumer<char> Stream, out double outDurationSecs)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#parse-a-duration-string */
    ...
    private static bool Is_Valid_Duration_Time_Component(DataConsumer<char> Stream)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#duration-time-component */
        ...
        ulong nextNonDigit = 0;
        if (!Stream.Scan(ch => !Is_Ascii_Digit(ch), out nextNonDigit, 0))
        {
            return false;
        }
    ...
    private static bool Consume_Duration_Time_Component(DataConsumer<char> Stream, out double outTimeInSeconds)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#duration-time-component */
        ...
        if (!Stream.Scan(ch => !Is_Ascii_Digit(ch), out ulong nextNonDigit, 0))
        {
            outTimeInSeconds = double.NaN;
            return false;
        }
    ...
    private static bool Parse_Date_Or_Time_String(DataConsumer<char> Stream, out DateTimeOffset outDateTime)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#parse-a-date-or-time-string */
        ...
        var StartPosition = Stream.LongPosition;
    ...
    private static bool Is_Valid_Simple_Color(DataConsumer<char> Stream)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-simple-colour */
    ...
    private static bool Is_Valid_Lowercase_Simple_Color(DataConsumer<char> Stream)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-lowercase-simple-colour */
    ...
    private static bool Parse_Simple_Color_String(DataConsumer<char> Stream, out SimpleColor outColor)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#rules-for-parsing-simple-colour-values */
    ...
    private static bool Parse_Legacy_Color_String(DataConsumer<char> Stream, out SimpleColor outColor)
    {/* Docs: https://html.spec.whatwg.org/multipage/common-microsyntaxes.html#rules-for-parsing-a-legacy-colour-value */

        Stream = new DataConsumer<char>(StringCommon.Trim(Stream.AsMemory(), UnicodeCommon.CHAR_SPACE), EOF);

        var mem = Stream.AsMemory();
        if (StringCommon.StriEq(mem.Span, "transparent"))
        {
            outColor = SimpleColor.MinValue;
            return false;
        }
        ...
        if (EColorExtensions.TryFromKeyword(StringCommon.Transform(mem, To_ASCII_Lower_Alpha), out EColor? outEnumValue))
        {
            ...
            outColor = new SimpleColor(outEnumValue.Value.R(), outEnumValue.Value.G(), outEnumValue.Value.B());
            return true;
        }
