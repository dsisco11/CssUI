    ...
    internal class CssDefinitions
    {
        ...
        static IEnumerable<StyleDefinition> Create_Block_Property_Definitions()
        {
            return new StyleDefinition[] {
                ...
                new StyleDefinition("top", false, EPropertyDirtFlags.Margin_Area, CssValue.Auto, ECssValueType.AUTO | ECssValueType.DIMENSION | ECssValueType.PERCENT, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalHeight), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Box_Top_Used)),
                new StyleDefinition("right", false, EPropertyDirtFlags.Margin_Area, CssValue.Auto, ECssValueType.AUTO | ECssValueType.DIMENSION | ECssValueType.PERCENT, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Box_Right_Used)),
                new StyleDefinition("bottom", false, EPropertyDirtFlags.Margin_Area, CssValue.Auto, ECssValueType.AUTO | ECssValueType.DIMENSION | ECssValueType.PERCENT, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalHeight), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Box_Bottom_Used)),
                new StyleDefinition("left", false, EPropertyDirtFlags.Margin_Area, CssValue.Auto, ECssValueType.AUTO | ECssValueType.DIMENSION | ECssValueType.PERCENT, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Box_Left_Used)),


                new StyleDefinition("width", false, EPropertyDirtFlags.Content_Area, CssValue.Auto, ECssValueType.DIMENSION | ECssValueType.PERCENT | ECssValueType.AUTO | ECssValueType.INHERIT, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                new StyleDefinition("height", false, EPropertyDirtFlags.Content_Area, CssValue.Auto, ECssValueType.DIMENSION | ECssValueType.PERCENT | ECssValueType.AUTO | ECssValueType.INHERIT, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalHeight)),


                new StyleDefinition("min-width", false, EPropertyDirtFlags.Content_Area, CssValue.Auto, ECssValueType.DIMENSION | ECssValueType.PERCENT | ECssValueType.AUTO, 0x0, Keywords.MinMaxSize, false, (E, Pct) => !E.Box.Containing_Box_Explicit_Width ? CssValue.Zero : CssValue.From_Number(Pct * Math.Max(0, E.Box.Containing_Block.LogicalWidth)), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Min_Width_Used) ),
                new StyleDefinition("min-height", false, EPropertyDirtFlags.Content_Area, CssValue.Auto, ECssValueType.DIMENSION | ECssValueType.PERCENT | ECssValueType.AUTO, 0x0, Keywords.MinMaxSize, false, (E, Pct) => !E.Box.Containing_Box_Explicit_Height ? CssValue.Zero : CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalHeight), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Min_Height_Used)),

                new StyleDefinition("max-width", false, EPropertyDirtFlags.Content_Area, CssValue.None, ECssValueType.DIMENSION | ECssValueType.PERCENT | ECssValueType.NONE, 0x0, Keywords.MinMaxSize, false, (E, Pct) => !E.Box.Containing_Box_Explicit_Width ? CssValue.None : CssValue.From_Number(Pct * Math.Max(0, E.Box.Containing_Block.LogicalWidth)), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Max_Width_Used)),
                new StyleDefinition("max-height", false, EPropertyDirtFlags.Content_Area, CssValue.None, ECssValueType.DIMENSION | ECssValueType.PERCENT | ECssValueType.NONE, 0x0, Keywords.MinMaxSize, false, (E, Pct) => !E.Box.Containing_Box_Explicit_Height ? CssValue.None :  CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalHeight), new Tuple<ECssPropertyStage, PropertyResolverFunc>(ECssPropertyStage.Used, CssPropertyResolver.Max_Height_Used)),
                ...
                new StyleDefinition("padding-top", false, EPropertyDirtFlags.Padding_Area, CssValue.Zero, AllowedTypes: ECssValueType.PERCENT | ECssValueType.DIMENSION, Percentage_Resolver: (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                new StyleDefinition("padding-right", false, EPropertyDirtFlags.Padding_Area, CssValue.Zero, AllowedTypes: ECssValueType.PERCENT | ECssValueType.DIMENSION, Percentage_Resolver: (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                new StyleDefinition("padding-bottom", false, EPropertyDirtFlags.Padding_Area, CssValue.Zero, AllowedTypes: ECssValueType.PERCENT | ECssValueType.DIMENSION, Percentage_Resolver: (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                new StyleDefinition("padding-left", false, EPropertyDirtFlags.Padding_Area, CssValue.Zero, AllowedTypes: ECssValueType.PERCENT | ECssValueType.DIMENSION, Percentage_Resolver: (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                ...
                new StyleDefinition("margin-top", false, EPropertyDirtFlags.Margin_Area, CssValue.Zero, AllowedTypes: ECssValueType.AUTO | ECssValueType.PERCENT | ECssValueType.DIMENSION, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                new StyleDefinition("margin-right", false, EPropertyDirtFlags.Margin_Area, CssValue.Zero, AllowedTypes: ECssValueType.AUTO | ECssValueType.PERCENT | ECssValueType.DIMENSION, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                new StyleDefinition("margin-bottom", false, EPropertyDirtFlags.Margin_Area, CssValue.Zero, AllowedTypes: ECssValueType.AUTO | ECssValueType.PERCENT | ECssValueType.DIMENSION, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth)),
                new StyleDefinition("margin-left", false, EPropertyDirtFlags.Margin_Area, CssValue.Zero, AllowedTypes: ECssValueType.AUTO | ECssValueType.PERCENT | ECssValueType.DIMENSION, 0x0, null, false, (E, Pct) => CssValue.From_Number(Pct * E.Box.Containing_Block.LogicalWidth))
            };
        }
        #endregion
    }
