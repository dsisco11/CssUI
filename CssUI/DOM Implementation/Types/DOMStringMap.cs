...
namespace CssUI.DOM
{
    ...
    {/* DOcs: https://html.spec.whatwg.org/multipage/dom.html#domstringmap */
        ...
        {
            bool hasAlpha = false;
            for (int i = 0; i < Name.Length; i++) { if (UnicodeCommon.Is_ASCII_Upper_Alpha(Name[i])) { hasAlpha = true; break; } }
        ...
        {
            if (0 == Name.IndexOf("data-") && !UnicodeCommon.Has_ASCII_Upper_Alpha(Name))
            {
