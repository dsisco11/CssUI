...
namespace CssUI.DOM
{
    ...
    public class FilterLocalName_Namespace : NodeFilter
    {
        ...
        public override ENodeFilterResult acceptNode(Node node)
        {
            ...
            if (ReferenceEquals(element.NamespaceURI, NamespaceURI) || StringExt.streq(element.NamespaceURI.AsSpan(), NamespaceURI.AsSpan()))
            {
                if (ReferenceEquals(element.localName, Name) || StringExt.streq(element.localName.AsSpan(), Name.AsSpan()))
                {
