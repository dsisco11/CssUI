...
namespace CssUI.CSS
{
    ...
    {/* Docs: https://www.w3.org/TR/selectors-4 */
        ...
        #region Constructors
        public CssSelector(ReadOnlySpan<char> Selector) : base(CssSelector.Parse(Selector))
        {
            this.IsFromStylesheet = false;
        }
        public CssSelector(bool IsFromStylesheet, ReadOnlySpan<char> Selector) : base(CssSelector.Parse(Selector))
        {
