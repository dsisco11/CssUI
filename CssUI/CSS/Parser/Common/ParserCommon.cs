...
namespace CssUI.CSS.Serialization
{
    ...
    public static class ParserCommon
    {
        ...
        /// <para>Used by <see cref="MediaFeature"/></para>
        /// </summary>
        ...
        public static bool Is_Combinator(CssToken A)
        {
            ...
            var tokStr = (A as IdentToken).Value;
        ...
        public static bool Is_Comparator(CssToken A)
        {
            ...
            if (A.Type == ECssTokenType.Ident)
            {
                ...
                return (identTok.Value.Equals("<=", StringComparison.OrdinalIgnoreCase) || identTok.Value.Equals(">=", StringComparison.OrdinalIgnoreCase));
            }
