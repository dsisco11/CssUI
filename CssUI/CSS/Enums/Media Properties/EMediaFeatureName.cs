...
{/* Docs: https://drafts.csswg.org/mediaqueries-4/#mf-dimensions */
    ...
    /// </summary>
    [EnumRecordProperties("aspect-ratio")]
    AspectRatio,
    [EnumRecordProperties("min-aspect-ratio")]
    Min_AspectRatio,
    [EnumRecordProperties("max-aspect-ratio")]
    Max_AspectRatio,
    ...
    /// </summary>
    [EnumRecordProperties("orientation")]
    Orientation,
    ...
    /// </summary>
    [EnumRecordProperties("resolution")]
    Resolution,
    [EnumRecordProperties("min-resolution")]
    Min_Resolution,
    [EnumRecordProperties("max-resolution")]
    Max_Resolution,

    /// <summary>
    /// The scan media feature describes the scanning process of some output devices.
    /// </summary>
    [EnumRecordProperties("scan")]
    Scan,
    ...
    /// </summary>
    [EnumRecordProperties("overflow-block")]
    OverflowBlock,
    ...
    /// </summary>
    [EnumRecordProperties("overflow-inline")]
    OverflowInline,
    ...
    Color,
    [EnumRecordProperties("min-color")]
    Min_Color,
    [EnumRecordProperties("max-color")]
    Max_Color,
    ...
    /// </summary>
    [EnumRecordProperties("color-index")]
    ColorIndex,
    [EnumRecordProperties("min-color-index")]
    Min_ColorIndex,
    [EnumRecordProperties("max-color-index")]
    Max_ColorIndex,
    ...
    /// </summary>
    [EnumRecordProperties("monochrome")]
    Monochrome,
    [EnumRecordProperties("min-monochrome")]
    Min_Monochrome,
    [EnumRecordProperties("max-monochrome")]
    Max_Monochrome,
    ...
    /// </summary>
    [EnumRecordProperties("color-gamut")]
    ColorGamut,

    /*
            [EnumRecordProperties("pointer")]
            Pointer,
            [EnumRecordProperties("hover")]
            Hover,
            [EnumRecordProperties("any-pointer")]
            AnyPointer,
            [EnumRecordProperties("any-hover")]
            AnyHover,
    */
}
