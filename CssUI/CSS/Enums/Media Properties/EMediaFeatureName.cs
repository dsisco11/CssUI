...
{/* Docs: https://drafts.csswg.org/mediaqueries-4/#mf-dimensions */
    ...
    /// </summary>
    [EnumData("aspect-ratio")]
    AspectRatio,
    [EnumData("min-aspect-ratio")]
    Min_AspectRatio,
    [EnumData("max-aspect-ratio")]
    Max_AspectRatio,
    ...
    [EnumData("resolution")]
    Resolution,
    [EnumData("min-resolution")]
    Min_Resolution,
    [EnumData("max-resolution")]
    Max_Resolution,
    ...
    /// </summary>
    [EnumData("color-index")]
    ColorIndex,
    [EnumData("min-color-index")]
    Min_ColorIndex,
    [EnumData("max-color-index")]
    Max_ColorIndex,
    ...
    [EnumData("monochrome")]
    Monochrome,
    [EnumData("min-monochrome")]
    Min_Monochrome,
    [EnumData("max-monochrome")]
    Max_Monochrome,
