...
namespace CssUI.Internal
{
	internal static class CssEnumTables
	{
		...
		static CssEnumTables()
		{
			...
			/* CssUI.EStyleUnit */
			maxIndex = (int)Enum.GetValues(typeof(CssUI.EStyleUnit)).Cast<CssUI.EStyleUnit>().Max();
			TABLE[10] = new string[maxIndex+1];
			TABLE[10][(int)CssUI.EStyleUnit.None] = "";
			TABLE[10][(int)CssUI.EStyleUnit.PX] = "px";
			TABLE[10][(int)CssUI.EStyleUnit.EM] = "em";
			TABLE[10][(int)CssUI.EStyleUnit.EX] = "ex";
			TABLE[10][(int)CssUI.EStyleUnit.CH] = "ch";
			TABLE[10][(int)CssUI.EStyleUnit.REM] = "rem";
			TABLE[10][(int)CssUI.EStyleUnit.VW] = "vw";
			TABLE[10][(int)CssUI.EStyleUnit.VH] = "vh";
			TABLE[10][(int)CssUI.EStyleUnit.VMIN] = "vmin";
			TABLE[10][(int)CssUI.EStyleUnit.VMAX] = "vmax";
			TABLE[10][(int)CssUI.EStyleUnit.DEG] = "deg";
			TABLE[10][(int)CssUI.EStyleUnit.GRAD] = "grad";
			TABLE[10][(int)CssUI.EStyleUnit.RAD] = "rad";
			TABLE[10][(int)CssUI.EStyleUnit.TURN] = "turn";
		...
		/* Generate Reverse lookup maps */
			...
			/* CssUI.EStyleUnit */
			KEYWORD.Add(new Dictionary<AtomicString, dynamic>());
			KEYWORD[10].Add(new AtomicString(""), CssUI.EStyleUnit.None);
			KEYWORD[10].Add(new AtomicString("px"), CssUI.EStyleUnit.PX);
			KEYWORD[10].Add(new AtomicString("em"), CssUI.EStyleUnit.EM);
			KEYWORD[10].Add(new AtomicString("ex"), CssUI.EStyleUnit.EX);
			KEYWORD[10].Add(new AtomicString("ch"), CssUI.EStyleUnit.CH);
			KEYWORD[10].Add(new AtomicString("rem"), CssUI.EStyleUnit.REM);
			KEYWORD[10].Add(new AtomicString("vw"), CssUI.EStyleUnit.VW);
			KEYWORD[10].Add(new AtomicString("vh"), CssUI.EStyleUnit.VH);
			KEYWORD[10].Add(new AtomicString("vmin"), CssUI.EStyleUnit.VMIN);
			KEYWORD[10].Add(new AtomicString("vmax"), CssUI.EStyleUnit.VMAX);
			KEYWORD[10].Add(new AtomicString("deg"), CssUI.EStyleUnit.DEG);
			KEYWORD[10].Add(new AtomicString("grad"), CssUI.EStyleUnit.GRAD);
			KEYWORD[10].Add(new AtomicString("rad"), CssUI.EStyleUnit.RAD);
			KEYWORD[10].Add(new AtomicString("turn"), CssUI.EStyleUnit.TURN);
