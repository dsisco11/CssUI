...
public class LayoutPipelineIntegrationTests
{
    ...
    /// NOTE: Skipped because ForceCascade triggers flags that cause infinite loop in event loop.
    /// This test will be re-enabled after Phase 14.2 (Fix infinite loop).
    /// </summary>
    [Fact(Skip = "ForceCascade triggers infinite loop - Phase 14.2")]
